...
insert into public.topics (slug, title, description, difficulty, lesson_count, icon, color_accent, order_index)
values
  ('fundamentals', 'Fundamentals of Astronomy', 'Core concepts of astronomy', 'Beginner', 12, '✨', '#00c8c8', 1),
  ('ethiopia', 'Astronomy & Ethiopia', 'Ethiopian astronomy heritage', 'Beginner', 8, '🇪🇹', '#f5c542', 2),
  ('solar-system', 'Solar System', 'Sun, planets and moons', 'Beginner', 15, '☀️', '#00c8c8', 3),
  ('planets', 'Planets', 'Deep dive into each planet', 'Beginner', 10, '🪐', '#00c8c8', 4),
  ('moon', 'Moon', 'Earth''s natural satellite', 'Beginner', 9, '🌙', '#f5c542', 5),
  ('stars', 'Stars', 'Stellar evolution and classification', 'Intermediate', 14, '⭐', '#f5c542', 6),
  ('black-holes', 'Black Holes', 'Gravity, singularities, event horizons', 'Advanced', 11, '🕳️', '#7c5cbf', 7),
  ('wormholes', 'Wormholes', 'Theoretical space tunnels', 'Advanced', 7, '🌀', '#7c5cbf', 8),
  ('nebulae', 'Nebulae', 'Cosmic gas clouds and star nurseries', 'Intermediate', 10, '🌌', '#f5c542', 9),
  ('asteroids', 'Asteroids', 'Space rocks and their orbits', 'Intermediate', 8, '☄️', '#f5c542', 10)
