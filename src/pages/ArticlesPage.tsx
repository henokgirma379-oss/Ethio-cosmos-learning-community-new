    ...
    <div className="relative min-h-screen bg-space-black text-white">
      ...
      <main className="relative z-10 flex min-h-screen items-center justify-center px-6 pt-16">
        <div className="text-center">
          ...
          <h1 className="mt-6 font-display text-4xl text-white">Coming Soon — Astronomy articles and news from Africa</h1>
          <p className="mt-4 text-slate-400">Fresh stories and insights will appear here.</p>
