    ...
    <div className="relative min-h-screen bg-space-black text-white">
      ...
      <main className="relative z-10 flex min-h-screen items-center justify-center px-6 pt-16">
        <div className="text-center">
          ...
          <h1 className="mt-6 font-display text-4xl text-white">Coming Soon — Curated astronomy resources and tools</h1>
          <p className="mt-4 text-slate-400">More tools and references are on their way.</p>
