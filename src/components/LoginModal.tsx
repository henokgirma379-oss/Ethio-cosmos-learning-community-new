      ...
      <div className="w-full max-w-md rounded-2xl border border-teal/30 bg-deep-navy p-8 shadow-[0_0_40px_rgba(0,200,200,0.15)]">
        {emailSent ? (
          <div className="text-center">
            ...
            <button
              onClick={onClose}
              className="mt-6 rounded-lg bg-teal px-6 py-3 font-semibold text-slate-950"
            >
              Got it
            </button>
          </div>
          ...
          <>
            ...
            <p className="mt-5 text-center text-sm text-slate-400">
              ...
              <button className="text-teal" onClick={() => { setMode(mode === 'signin' ? 'signup' : 'signin'); setEmailSent(false) }}>
